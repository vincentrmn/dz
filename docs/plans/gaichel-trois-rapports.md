...
| 3 | Non-régression : fiche 1 (wbs inchangé) régénérée sur W donne le même « Traxxeo : N ligne(s) » avant et après le changement du nœud | Deux lignes `GET /api/runs` fiche 1, période W, même N, statut Succès | échec : avant = run 314 (21/09, manuel, sans email) « Succès · Traxxeo : 0 ligne(s) · RT : 0 message(s), 0 photo(s) · BLL : 1 message(s), 0 photo(s) » ; après = en attente du MCP n8n (nœud non modifié) |
